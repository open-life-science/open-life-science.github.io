...
***TO BE CONTINUED**: You can now read last part of the report: [**Where we want to go**]({% link _posts/2020-10-01-annual-report-part-3.md %}). If you missed it, you can also read the first part: [**Where we started**]({% link _posts/2020-10-01-annual-report-part-1.md %})*
