...
Communities that have participated in an OLS training cohort, or worked with OLS in other capacities, are welcome to apply to become a fiscally sponsored community ([FSC](https://we-are-ols.org/open-incubator/fiscal-hosting/#fsc)).
...
[What if we don’t have three members of our community who are willing to be signatories yet?](#what-if-we-don’t-have-three-members-of-our-community-who-are-willing-to-be-signatories-yet?)
...
[We already have an organisation, but we’d like to work with OLS on a project](#we-already-have-an-organisation,-but-we’d-like-to-work-with-ols-on-a-project)
...
Please fork the [FSC community template repo](https://github.com/open-life-science/fiscally-sponsored-community-templates), which should guide you through creating issues as to-dos for the basic docs we expect. [You can also read our internal policy page for FSCs and Fellows.](https://we-are-ols.org/open-incubator/fiscal-hosting-policies/) 
...
Please fork the Incubation Fellow community template repo, which should guide you through creating issues as to-dos for the basic docs we expect. [You can also read our internal policy page for FSCs and Fellows.](https://we-are-ols.org/open-incubator/fiscal-hosting-policies/)
...
### …I don’t have any experience with applying for grants. {#…i-don’t-have-any-experience-with-applying-for-grants.}
...
Please go ahead and [fork the repo](https://github.com/open-life-science/fiscally-sponsored-community-templates) to apply to become an FSC or a Fellow. Send us an email at fsc \[at\] [we-are-ols.org](http://we-are-ols.org) to let us know you’re working on the repo as well\!
