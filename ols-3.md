---
layout: page
title: Welcome to the 3rd cohort of Open Life Science program!
...
{% assign metadata = site.data.ols-3-metadata %}
...
OLS's second cohort (OLS-3) will be conducted from September 2020 until December 2020.
...
This partnership will offer training and mentoring to interested members from Turing and _The Turing Way_ communities to join the second cohort (OLS-3) individually or in teams.
...
We have [a short guide for invited speakers]({% link _ols-3/speaker-guide.md %}).
