...
We will be running our [8th cohort]({% link _ols-8/projects-participants.md %})
(Sep 2021 - Jan 2022).
A complete syllabus of this cohort can be found [here]({% link _ols-8/schedule.md %}).
...
Every second week, we host online cohort calls (1.5 hours each) where [relevant content related to Open Life Science]({% link _ols-8/schedule.md %}) is shared and discussed with all participants of the program.
...
The OLS team will share a collaborative document with the cohort call agenda in your invitation email, which is also linked to the [online schedule]({% link _ols-8/schedule.md %})
