...
Every second week, we host online cohort calls (1.5 hours each) where [relevant content related to OLS]({% link _ols-8/schedule.md %}) is shared and discussed with all participants of the program.
