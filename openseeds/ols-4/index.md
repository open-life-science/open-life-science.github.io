...
description: Syllabus, schedule, and projects from Open Seeds Cohort 4 (OLS-4).
...
{% include _includes/cohort-metadata.html cohort='ols-4' program='openseeds'  %}
...
Look up the shared notes for each call linked to the [schedule]({% link openseeds/ols-4/schedule.md %}) in this website.
...
We have [a short guide for invited speakers]({% link openseeds/ols-4/speaker-guide.md %}).
