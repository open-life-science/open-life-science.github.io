...
We will be running our [fourth cohort]({% link openseeds/ols-4/projects-participants.md %})
(Sep 2021 - Jan 2022).
A complete syllabus of this cohort can be found [here]({% link openseeds/ols-4/schedule.md %}).
...
Every second week, we host online cohort calls (1.5 hours each) where [relevant content related to Open Life Science]({% link openseeds/ols-4/schedule.md %}) is shared and discussed with all participants of the program.
...
The OLS team will share a collaborative document with the cohort call agenda in your invitation email, which is also linked to the [online schedule]({% link openseeds/ols-4/schedule.md %})
