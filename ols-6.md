...
For the sixth round of the OLS program, we welcome [{{ p-participants | size }} participants](/ols-6/projects-participants#participants) with [{{ projects | size }} projects](/ols-6/projects-participants#projects).
...
{% include _includes/people-list.html people-list=metadata.possible-mentors people-expertise=metadata.possible-mentors-with-expertise %}
